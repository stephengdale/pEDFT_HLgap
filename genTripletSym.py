...
def genData(func, basis):
    ...
    names = ['acetaldehyde', 'acetylene', 'ammonia', 'carbon_monoxide', 'cyclopropene', 'diazomethane', 'dinitrogen', 'ethylene', 'formaldehyde', 'formamide', 'hydrogen_sulfide', 'ketene', 'methanimine', 'nitrosomethane', 'thioformaldehyde', 'water'] 
    trans = [         'App',        'Au',     'App',              'B1',           'B2',           'A2',         'Au',      'B2u',           'A2',       'App',               'A2',     'A2',         'App',            'App',               'A2',    'B1'] 
